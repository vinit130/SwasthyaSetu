        ...
        <form onSubmit={handleLookup} className="flex flex-col sm:flex-row items-center gap-3">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2.5 text-sm font-mono border border-slate-300 bg-white text-slate-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 uppercase tracking-wider"
            />
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <button
              type="submit"
              disabled={loading}
              className="w-full sm:w-auto px-6 py-2.5 text-sm font-bold text-white bg-purple-700 hover:bg-purple-800 disabled:opacity-50 rounded-xl shadow-xs transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="px-3 py-2.5 text-xs text-purple-700 bg-purple-50 hover:bg-purple-100 rounded-xl border border-purple-200 whitespace-nowrap font-medium cursor-pointer"
            >
              Paste Demo
            </button>
          </div>
          ...
          <div className="p-5 border-b border-slate-200 bg-purple-50/40 flex flex-wrap items-center justify-between gap-3">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="px-2.5 py-1 text-xs font-bold rounded-lg bg-emerald-100 text-emerald-800 flex items-center gap-1 border border-emerald-200">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="pt-4 border-t border-slate-200 flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="px-3 py-1 text-xs font-bold rounded-full bg-purple-100 text-purple-900 border border-purple-200">
                  {referral.status}
                </span>
              </div>
                ...
                {referral.status === 'PATIENT ARRIVED' && (
                  <>
                    <Link
                      ...
                      className="px-4 py-2 text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-xl border border-slate-300 flex items-center gap-1.5 cursor-pointer"
                    >
