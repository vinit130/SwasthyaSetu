      ...
      {activeTab === 'prescriptions' && (
        <div className="space-y-4">
          {(!consultations || consultations.length === 0) ? (
            ...
            consultations.map((c) => (
              <Card key={c._id} className="p-5 bg-white border border-slate-200 space-y-3.5">
      ...
      {activeTab === 'referrals' && (
        <div className="space-y-4">
          {(!referrals || referrals.length === 0) ? (
            ...
            referrals.map((r) => (
              <Card key={r._id} className="p-5 bg-white border border-slate-200 space-y-3">
                <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
                  <div className="flex items-center gap-2">
      ...
      {activeTab === 'followups' && (
        <div className="space-y-4">
          {(!followups || followups.length === 0) ? (
            ...
            followups.map((f) => (
              <Card key={f._id} className="p-5 bg-white border border-slate-200 space-y-2.5">
